            ...
            <div class="stand-form">
                ...
                <form method="post" enctype="multipart/form-data" class="rf">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="PHONE" class="w-text width-half rfield" value="<?=$_REQUEST["PHONE"]?>">
                    </fieldset>
                    
                    <fieldset>
                        <div class="caption">E-mail <span class="required">*</span></div>
                        <input type="text" name="EMAIL" id="EMAIL33" class="w-text width-half rfield" value="<?=$_REQUEST["EMAIL"]?>">
                    </fieldset>
                    
                    <fieldset>
                        <div class="caption">Сайт</div>
                        <input type="text" site="SITE" class="w-text width-halfvalue=" <?=$_REQUEST["SITE"]?>>
                    </fieldset>
                    
                    <fieldset>
                        <div class="caption">Название выставки <span class="required" value="<?=$_REQUEST["CONTACT_FACE"]?>">*</span></div>
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="TIME" class="w-text width-half rfield" value="<?=$_REQUEST["TIME"]?>">
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="NUMBER_PLAN" class="w-text width-half" value="<?=$_REQUEST["NUMBER_PLAN"]?>">
                    </fieldset>
                    ...
                    <h3>Также Вы можете более подробно заполнить информацию о заказе и заполнить следующие поля</h3>
                    ...
                    <fieldset>
                        ...
                        <select name="FLOOR" data-placeholder="Выберите" class="chosen-select width-half">
                             <option value=""></option>
                    ...
                    <fieldset>
                        ...
                        <select name="MEETING_ROOM" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                    ...
                    <fieldset>
                        ...
                        <select name="INFO_STAND" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name="SHOWCASE" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name="SHALVES" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name = "CLOSE_MEETING" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name="OPEN_MEETING" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name="KITCHEN" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <select name="UTILITY_ROOM_2" data-placeholder="Выберите" class="chosen-select width-half yes-or-not">
                            <option value=""></option>
                            <option value="Нет" selected>Нет</option>
                            <option value="Да">Да</option>
                        </select>
                    ...
                    <fieldset>
                        <div class="caption">Ориентировочный бюджет <span class="required">*</span></div>
                        <input name="BUD" type="text" class="w-text width-half  rfield" value="<?=$_REQUEST["BUD"]?>">
                    </fieldset>
                    
                    <fieldset>
                        <div class="caption">Ориентировочная дата сдачи проекта <span class="required">*</span></div>
                        <input name="DATE_S" type="text" class="w-text width-half  rfield" value="<?=$_REQUEST["DATE_S"]?>">
                    </fieldset>
                    ...
                    <input type="submit" class="blue-btn" name="sendform" id="sendform" value="Отправить заказ">
