...
*/
	...
	*/
		function buildFilmstrip() {
			...
			var navNext = $('<img />');
			navNext.addClass('nav-next').attr('src','images/index-slide-next.png').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showNextItem);
			var navPrev = $('<img />');
			navPrev.addClass('nav-prev').attr('src','images/index-slide-prev.png').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showPrevItem);
			if(filmstrip_orientation=='horizontal') {
